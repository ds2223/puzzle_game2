...
public class tumu extends MonoBehaviour {
...
private function DropBall(count: int) {
	for (var i = 0; i < count; i++) {
		...
		var spriteId: int = Random.Range(0, 1); 				//ボールの画像のid(ボールの色)をランダムに設定
...
private function BigDropBall() {
		...
		var spriteId2: int = Random.Range(0, 1); 					//ボールの画像のid(ボールの色)をランダムに設定
