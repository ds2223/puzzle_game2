...
public class sei1 extends MonoBehaviour {
...
private var isTutorial = false; 		//tutorialのクリア判定
...
public var num = 1;
	...
	private function DropBall(count: int) {		
			for (var i = 0; i < count; i++) {
				...
				var spriteId: int = Random.Range(0, num); 				//ボールの画像のid(ボールの色)をランダムに設定
